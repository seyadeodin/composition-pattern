...
export function NotificationAction({ icon: Icon, ...rest }: NotificationActionProps) {
  return (
      <button  
        {...rest}
        className={twMerge("w-8 h-8 rounded flex items-center justify-center dark:bg-zinc-800 bg-zinc-400 dark:hover:bg-zinc-700 hover:bg-zinc-500", rest.className)}
      >
